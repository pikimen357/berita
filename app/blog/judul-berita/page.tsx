export default function Home() {
    return (
        <>
            <h1>Berita Banjir Sumatra</h1>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio sit atque dolores dolor enim ipsum rem? Rem alias, cum dolorum corrupti nihil, aut ea error architecto mollitia omnis autem quidem?
